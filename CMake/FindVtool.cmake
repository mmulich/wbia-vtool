...
# VTOOL_LIBRARIES - Libraries needed to use vtool.
# VTOOL_DEFINITIONS - Compiler flags for vtool.

find_package(PkgConfig)
pkg_check_modules(PC_VTOOL vtool)
set(VTOOL_DEFINITIONS ${PC_VTOOL_CFLAGS_OTHER})

find_path(VTOOL_INCLUDE_DIR vtool/vtool.hpp
    HINTS ${PC_VTOOL_INCLUDEDIR} ${PC_VTOOL_INCLUDE_DIRS})

find_library(VTOOL_LIBRARY vtool
    HINTS ${PC_VTOOL_LIBDIR} ${PC_VTOOL_LIBRARY_DIRS})
